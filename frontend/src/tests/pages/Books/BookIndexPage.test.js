...
describe("BookIndexPage tests", () => {
    ...
    test("renders correct fields", () => {
        ...
        const title = screen.getByText("Mocking Freebirds");
        expect(title).toBeInTheDocument();

        const description = screen.getByText("Mock");
    ...
    test("delete button calls delete and reloads page", async () => {
        ...
        const expectedMessage = `BookIndexPage deleteCallback: {"id":3,"title":"Mocking Freebirds","description":"Mock","author":"Tim","date":"2023-04-27","publisher":"yuh"}`;
