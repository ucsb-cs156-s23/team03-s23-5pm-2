        ...
        <Container>
          ...
          <Navbar.Collapse className="justify-content-between">
            ...
            <Nav className="mr-auto">
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="EnergyDrinks" id="appnavbar-energydrinks-dropdown" data-testid="appnavbar-energydrinks-dropdown" >
                    <NavDropdown.Item href="/energydrinks/list" data-testid="appnavbar-energydrinks-list">List</NavDropdown.Item>
                    {
                      hasRole(currentUser, "ROLE_ADMIN") && (
                        <NavDropdown.Item href="/energydrinks/create" data-testid="appnavbar-energydrinks-create">Create</NavDropdown.Item>
                      )
                    }
                  </NavDropdown>
                )
            ...
            <Nav className="mr-auto">
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Books" id="appnavbar-books-dropdown" data-testid="appnavbar-books-dropdown">
                    <NavDropdown.Item href="/books/list" data-testid="appnavbar-books-list">
                      List
                    </NavDropdown.Item>
                    {hasRole(currentUser, "ROLE_ADMIN") && (
            ...
            <Nav className="mr-auto">
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Restaurants" id="appnavbar-restaurants-dropdown" data-testid="appnavbar-restaurants-dropdown">
                    <NavDropdown.Item href="/restaurants/list" data-testid="appnavbar-restaurants-list">
                      List
                    </NavDropdown.Item>
                    {hasRole(currentUser, "ROLE_ADMIN") && (
